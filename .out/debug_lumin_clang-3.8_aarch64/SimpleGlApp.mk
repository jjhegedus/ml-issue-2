...
$(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.o : $(SimpleGlApp_BASE)/LoadShader.cpp $(SimpleGlApp_BASE)/SimpleGlApp.mabu $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/warn/on.option
	$(INFO) \[SimpleGlApp\]\ Compiling\ 'LoadShader.cpp'...
	$(ECHO) $(COMPILER_PREFIX) $(CXX) -c $(SimpleGlApp_BASE)/LoadShader.cpp -o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.o -MD -MP -MF $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.d $(SimpleGlApp_CPPFLAGS) $(SimpleGlApp_CXXFLAGS)
	$(ECHO) echo $(SimpleGlApp_BASE)/LoadShader.cpp : >> $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.d
...
$(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.o : $(SimpleGlApp_BASE)/utilities.cpp $(SimpleGlApp_BASE)/SimpleGlApp.mabu $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/warn/on.option
	$(INFO) \[SimpleGlApp\]\ Compiling\ 'utilities.cpp'...
	$(ECHO) $(COMPILER_PREFIX) $(CXX) -c $(SimpleGlApp_BASE)/utilities.cpp -o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.o -MD -MP -MF $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.d $(SimpleGlApp_CPPFLAGS) $(SimpleGlApp_CXXFLAGS)
	$(ECHO) echo $(SimpleGlApp_BASE)/utilities.cpp : >> $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.d
...
SimpleGlApp-clean :: 
	...
	$(ECHO) $(RM) -rf $(SimpleGlApp_OUTPUT)/SimpleGlApp $(SimpleGlApp_OUTPUT)/SimpleGlApp.sym $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.d $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/main.cpp.o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/main.cpp.d
	$(ECHO) $(RM) -rf $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.d $(SimpleGlApp_OUTPUT)/bin/libc++_shared.so $(SimpleGlApp_OUTPUT)//fragment-shader-old.glsl $(SimpleGlApp_OUTPUT)//fragment-shader.glsl
