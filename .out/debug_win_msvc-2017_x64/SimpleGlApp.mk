...
$(SimpleGlApp_OUTPUT)/SimpleGlApp.exe : $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/main.cpp.o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.o $(SimpleGlApp_OUTPUT)/glad_wgl.c-178a01748c12a876.o $(SimpleGlApp_OUTPUT)/glad.c-178a01748c12a876.o $(SimpleGlApp_BASE)/SimpleGlApp.mabu C:/Projects/Git/jjhegedus/simple_gl_app/glad.comp C:/Projects/Git/jjhegedus/simple_gl_app/glfw.comp $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/warn/on.option
	$(INFO) \[SimpleGlApp\]\ Linking\ program\ 'SimpleGlApp.exe'...
	$(ECHO) cd $(SimpleGlApp_OUTPUT) && $(LINKTOUCH) $(SimpleGlApp_OUTPUT)/SimpleGlApp.exe $(LINKER_PREFIX) $(LD) -nologo -out:SimpleGlApp.exe -machine:x64 obj.SimpleGlApp/LoadShader.cpp.o obj.SimpleGlApp/main.cpp.o obj.SimpleGlApp/utilities.cpp.o glad_wgl.c-178a01748c12a876.o glad.c-178a01748c12a876.o $(SimpleGlApp_LIBS) $(SimpleGlApp_LDFLAGS)

$(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.o : $(SimpleGlApp_BASE)/LoadShader.cpp $(SimpleGlApp_BASE)/SimpleGlApp.mabu C:/Projects/Git/jjhegedus/simple_gl_app/glad.comp C:/Projects/Git/jjhegedus/simple_gl_app/glfw.comp $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/warn/on.option
	$(INFO) \[SimpleGlApp\]\ Compiling\ 'LoadShader.cpp'...
	$(ECHO) $(PYTHON) $(DEPGEN) $(SimpleGlApp_BASE)/LoadShader.cpp $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.d $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.o -i C:/Projects/third-party/glad/include -i C:/Projects/third-party/glfw/include -i $(MLSDK)/include -d ML_WINDOWS -d USE_GLFW=1
	$(ECHO) $(COMPILER_PREFIX) $(CXX) -nologo -TP -c $(SimpleGlApp_BASE)/LoadShader.cpp -Fo$(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.o -FS -Fd$(SimpleGlApp_OUTPUT)/SimpleGlApp.pdb $(SimpleGlApp_CPPFLAGS) $(SimpleGlApp_CXXFLAGS)

-include $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.d
$(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/main.cpp.o : $(SimpleGlApp_BASE)/main.cpp $(SimpleGlApp_BASE)/SimpleGlApp.mabu C:/Projects/Git/jjhegedus/simple_gl_app/glad.comp C:/Projects/Git/jjhegedus/simple_gl_app/glfw.comp $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/warn/on.option
...
$(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.o : $(SimpleGlApp_BASE)/utilities.cpp $(SimpleGlApp_BASE)/SimpleGlApp.mabu C:/Projects/Git/jjhegedus/simple_gl_app/glad.comp C:/Projects/Git/jjhegedus/simple_gl_app/glfw.comp $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/warn/on.option
	$(INFO) \[SimpleGlApp\]\ Compiling\ 'utilities.cpp'...
	$(ECHO) $(PYTHON) $(DEPGEN) $(SimpleGlApp_BASE)/utilities.cpp $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.d $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.o -i C:/Projects/third-party/glad/include -i C:/Projects/third-party/glfw/include -i $(MLSDK)/include -d ML_WINDOWS -d USE_GLFW=1
	$(ECHO) $(COMPILER_PREFIX) $(CXX) -nologo -TP -c $(SimpleGlApp_BASE)/utilities.cpp -Fo$(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.o -FS -Fd$(SimpleGlApp_OUTPUT)/SimpleGlApp.pdb $(SimpleGlApp_CPPFLAGS) $(SimpleGlApp_CXXFLAGS)

-include $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.d
$(SimpleGlApp_OUTPUT)/glad_wgl.c-178a01748c12a876.o : C:/Projects/third-party/glad/src/glad_wgl.c $(SimpleGlApp_BASE)/SimpleGlApp.mabu C:/Projects/Git/jjhegedus/simple_gl_app/glad.comp C:/Projects/Git/jjhegedus/simple_gl_app/glfw.comp $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/warn/on.option
...
$(SimpleGlApp_OUTPUT)/glad.c-178a01748c12a876.o : C:/Projects/third-party/glad/src/glad.c $(SimpleGlApp_BASE)/SimpleGlApp.mabu C:/Projects/Git/jjhegedus/simple_gl_app/glad.comp C:/Projects/Git/jjhegedus/simple_gl_app/glfw.comp $(MLSDK)/.metadata/components/ml_sdk.comp $(MLSDK)/.metadata/components/ml_sdk_common.comp $(MLSDK)/tools/mabu/data/components/OpenGL.comp $(MLSDK)/tools/mabu/data/components/stdc++.comp $(MLSDK)/tools/mabu/data/configs/debug.config $(MLSDK)/tools/mabu/data/options/debug/on.option $(MLSDK)/tools/mabu/data/options/exceptions/on.option $(MLSDK)/tools/mabu/data/options/magicleap.option $(MLSDK)/tools/mabu/data/options/optimize/off.option $(MLSDK)/tools/mabu/data/options/package/debuggable/on.option $(MLSDK)/tools/mabu/data/options/runtime/shared.option $(MLSDK)/tools/mabu/data/options/standard-c++/11.option $(MLSDK)/tools/mabu/data/options/warn/on.option
...
SimpleGlApp-clean :: 
	...
	$(ECHO) $(RM) -rf $(SimpleGlApp_OUTPUT)/SimpleGlApp.exe $(SimpleGlApp_OUTPUT)/SimpleGlApp.ilk $(SimpleGlApp_OUTPUT)/SimpleGlApp.idb $(SimpleGlApp_OUTPUT)/SimpleGlApp.pdb $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/LoadShader.cpp.d
	$(ECHO) $(RM) -rf $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/main.cpp.o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/main.cpp.d $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.o $(SimpleGlApp_OUTPUT)/obj.SimpleGlApp/utilities.cpp.d $(SimpleGlApp_OUTPUT)/glad_wgl.c-178a01748c12a876.o $(SimpleGlApp_OUTPUT)/glad_wgl.c-178a01748c12a876.d
	$(ECHO) $(RM) -rf $(SimpleGlApp_OUTPUT)/glad.c-178a01748c12a876.o $(SimpleGlApp_OUTPUT)/glad.c-178a01748c12a876.d $(SimpleGlApp_OUTPUT)//fragment-shader-old.glsl $(SimpleGlApp_OUTPUT)//fragment-shader.glsl $(SimpleGlApp_OUTPUT)//vertex-shader.glsl
